    ...
    var calendar = function(calendarId){
                ...
                for(var j=0;j<7;j++){
                    if(remainlastday <= Maxdate){
                        if(thisyear == year && thismonth == month && today == remainlastday){
                            str +='<td class="redTr today" title="今天">'+ remainlastday++ +'</td>';
                        }else{
        ...
        c.init = function(){
            ...
            if(loadStyles.mark != 'load'){
                loadStyles(".calendarDiv {width:360px;text-align:center;}\
            .Table{width:360px;height:200px;border-top:3px solid rgba(4,44,4,0.5);font-weight:bold;}\
            .box{text-align:center;width:360px;height:22px;font-weight:bold;font-size:21px;}\
            .box-dec{border:none;text-align:center;font-weight:bold;float:left;width:30px;}\
            .box-add{border:none;text-align:center;font-weight:bold;float:right;width:30px;}\
            .Tr,th{text-align:center;}\
            .Tr{color:rgba(22,22,22,0.5)}\
            .redTr{color:red;text-align:center;}\
            .today{cursor: context-menu;}\
            .calendar{background:#ccc;width:360px;}\
            ...
            document.querySelector('#dec').setAttribute('title','上一年');
            //生成存储年份的span
            c.buildPart({
                node : 'span',
                id : 'Year',
            ...
            document.querySelector('#add').setAttribute('title','下一年');
            //生成存储日历的table
            c.buildPart({
                node : 'table',
                id : 'calendarTable',
